(function(j, h, c, g, d, k, f) {
  ...
  var e = (j.$Jease$ = {
    ...
    $InOutElastic: function(a) {
      ...
      var b = 0.45,
        d = 0.1125;
      return (a *= 2) < 1
        ? -0.5 * c.pow(2, 10 * (a -= 1)) * c.sin((a - d) * 2 * c.PI / b)
        : c.pow(2, -10 * (a -= 1)) * c.sin((a - d) * 2 * c.PI / b) * 0.5 + 1;
    },
    $InBack: function(a) {
      var b = 1.70158;
      return a * a * ((b + 1) * a - b);
  ...
  var b = (j.$Jssor$ = new function() {
    ...
    function Ib() {
      if (!N) {
        N = { tg: "ontouchstart" in j || "createTouch" in h };
        var a;
        if (F.pointerEnabled || (a = F.msPointerEnabled))
          N.Vd = a ? "msTouchAction" : "touchAction";
      }
      return N;
    }
    function w(g) {
      if (!t) {
        t = -1;
        if (
          ub == "Microsoft Internet Explorer" &&
          !!j.attachEvent &&
          !!j.ActiveXObject
        ) {
    ...
    function Q(d, a) {
      ...
      if (a) {
        ...
        if (I()) {
          if (a.$TranslateX || a.$TranslateY || a.$TranslateZ != f)
            c +=
              " translate3d(" +
              (a.$TranslateX || 0) +
              "px," +
    ...
    var V = { $Top: g, $Right: g, $Bottom: g, $Left: g, u: g, v: g };
    i.wf = function(a) {
      var b = i.$CreateDiv();
      s(b, { Lc: "block", ob: i.I(a), $Top: 0, $Left: 0, u: 0, v: 0 });
      var d = i.Fd(a, V);
      i.Cb(b, a);
      i.$AppendChild(b, a);
      var e = i.Fd(a, V),
    ...
    function s(h, l) {
      ...
      function k(b, d, a) {
        ...
        b.qb(p(300, 300));
        return p(
          c.min(e.x, f.x, g.x, h.x) + d / 2,
          c.min(e.y, f.y, g.y, h.y) + a / 2
        );
      }
      function a(d, a) {
        a = a || {};
    ...
    i.Oc = function(c, d) {
      ...
      if (c)
        if (b.Xd(c)) a = { ib: a };
        else if (b.Xd(c.$Clip)) a.$Clip = { ib: c.$Clip };
      a.ib = a.ib || d;
    ...
    i.zd = function(n, j, s, t, B, C, o) {
      ...
      if (
        ...
        !a.$Clip.B &&
        !a.$Clip.z &&
        a.$Clip.$Right == o.$OriginalWidth &&
        a.$Clip.$Bottom == o.$OriginalHeight
      )
        a.$Clip = g;
      return a;
    };
    ...
    q = (j.$JssorSlideshowFormations$ = new function() {
      ...
      h.$FormationRectangleCross = function(f) {
        for (
          ...
          for (a = 0; a < i; a++)
            g(j, c.round(k - c.max(d - c.abs(b - d), e - c.abs(a - e))) - 1, [
              a,
              b
            ]);
        return j;
    ...
    f.Ec = function(x) {
      if (!w) {
        ...
        for (var f = 0; f < u; f++) {
          ...
          D[f] = k;
          e.$ActionMode & 1 &&
            b.$AddEvent(k, "click", b.$CreateCallback(g, v, f));
          e.$ActionMode & 2 &&
            b.$AddEvent(k, "mouseenter", b.$CreateCallback(g, v, f));
          A[f] = b.Wb(k);
        }
        w = d;
      }
  ...
  j.$JssorThumbnailNavigator$ = function(f, E) {
    ...
    function D(m, f) {
      ...
      a.$ActionMode & 2 &&
        b.$AddEvent(c, "mouseenter", b.$CreateCallback(g, i, 1));
    }
    r.uc = function(a, f, d) {
      if (a != u) {
        var b = u;
    ...
    function z(t, u, h) {
      ...
      if (a && e) {
        ...
        if (a.bb < p) {
          ...
          k = new l(a.bb, q - j, { yc: q - a.bb, af: d });
          k.P(e, d);
        }
        i && a.Ac.push(i);
        k && a.Yd.push(k);
  ...
  var i = (j.$JssorSlider$ = function() {
    ...
    function wc(e, k, o) {
      ...
      l.$ScaleSize = function(q, p, t) {
        ...
        if (!f) {
          f = b.wf(e);
          g = e.parentNode;
          i = { $Scale: b.mc(e, m.Ab, 1), $AutoCenter: b.mc(e, m.yb) };
        ...
        b.$CssHeight(g, f.v * r);
        var u =
            (b.$IsBrowserIE() && b.$BrowserEngineVersion() < 9) ||
            (b.$BrowserEngineVersion() < 10 && b.$IsBrowserIeQuirks())
              ? l
              : 1,
          w = (s - u) * f.u / 2,
          x = (r - u) * f.v / 2;
    ...
    function Jc() {
      ...
      b.dg = function() {
        ...
        var d = c.round(a),
          ...
          f = a - c.floor(a),
          e = Wb(a);
        return { zb: g, fg: d, ob: f, Lc: a, eg: e };
      };
      b.fc = function(e, b) {
        var g = t(b);
        if (c.abs(b - e) > 1e-5) {
    ...
    function Wb(a) {
      return !(C & 1) && (a - E < 0.0001 || I - a < 0.0001);
    }
    function cc() {
      Eb = Z;
      Ub = z.qd();
    ...
    function vc(c) {
      ...
      if (v === d)
        if (R) {
          b.$StopEvent(c);
          while (a && v !== a) {
            (a.tagName == "A" || b.$Attribute(a, "data-jssor-button")) &&
              b.$CancelEvent(c);
            a = a.parentNode;
          }
        } else u & 4 && (u = 0);
      ...
      if ((!A && (M || !(H & 12))) || n.$NaviQuitDrag) {
        ...
        if (!(C & 1)) {
          if (o) a = t(a);
            ...
            C & 2 &&
            ((a < 0 && c.abs(b - E) < 0.0001) ||
              (a > q - U && c.abs(b - I) < 0.0001))
          )
            a = a < 0 ? I : E;
          a = Cb(a);
          if (I - a < 0.5) a = I;
    ...
    a.Ce = function(a) {
      return c.abs(a - E) < 0.0001;
    };
    a.Be = function(a) {
      return c.abs(a - I) < 0.0001;
    };
    a.$PlayTo = Ab;
    a.$GoTo = function(a) {
      z.Xb(a, a, 0);
    ...
    a.Ub = function(x, l) {
      ...
      bb = b.s({ $Class: r }, n.$CaptionSliderOptions);
      ...
      vb = n.$SlideDuration;
      Lb = new Ac();
      if (n.$HWA && (!b.$IsBrowserFireFox() || ub))
        Hb = function(a, c, d) {
      ...
      if (q) {
        ...
        if (kb) {
          ...
          ec =
            ...
            q > 1 &&
            Gb &&
            (!b.$IsBrowserIE() || b.$BrowserVersion() >= 9);
        }
        if (!(C & 1)) {
          O = cb / gb;
          E = O;
        ...
        a.$ScaleSize(K, J);
        Mb();
        n.$ArrowKeyNavigation &&
          b.$AddEvent(h, "keydown", function(a) {
