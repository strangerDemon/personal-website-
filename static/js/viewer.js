...
(function (factory) {
    ...
    window.lightbox = factory(window.jQuery);
})(function ($) {
    ...
    $.extend(prototype, {
        ...
        show: function () {
            ...
            this.$element.one(EVENT_SHOWN, $.proxy(function () {
                //原  this.view((this.target ? this.$images.index(this.target) : 0) || this.index);
               // console.log(this.$images.index(this.target)  || this.index);
      ...
      '<div class="viewer-container">' +
        ...
        '<div class="viewer-footer">' +
          ...
          '<ul class="viewer-toolbar">' +
            ...
            '<li class="viewer-inbox" data-action="inbox"></li>' +
            '<li class="viewer-search" data-action="search"></li>' +
          '</ul>' +
