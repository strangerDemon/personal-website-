      ...
      define([
        ...
        MainBgVisual.prototype = {
          ...
          start: function (worksNumber) {
            ...
            TweenLite.to(this.extraMarker, 1, {
              yPos: 0,
              ease: Power2.easeOut,
              ease: 'Bounce.easeOut',
              delay: .6
            });
            TweenLite.to(this.animationCircle, 1, {
              start: -Math.PI / 2,
              end: 3 / 2 * Math.PI,
              ease: 'Power2.easeOut',
              delay: 0
            }); //, onComplete: circleAnimationDone });
          ...
          update: function () {
            ...
            //
            this.ctx.clearRect(0, 0, window.innerWidth * windowModel.scaleFactor, window.innerHeight *
              windowModel.scaleFactor);
          ...
          startRectAnimation: function () {
            ...
            TweenLite.to(this, .6, {
              rect2TopRightX: leftPos,
              ease: "Power1.easeOut",
              delay: .3
            });
            TweenLite.to(this, .6, {
              rect2BotRightX: leftPos,
              ease: "Power4.easeOut",
              delay: .3
            });
